...
namespace MediaDevices
{
    ...
    public class ObjectAddedEventArgs : MediaDeviceEventArgs
    {
        ...
        public string? ObjectFullFileName
        {
            get
            {
                return ObjectId != null ? Item.Create(this.MediaDevice, this.ObjectId).FullName : null;
            }
        }
        ...
        {
            return ObjectId != null ? Item.Create(this.MediaDevice, this.ObjectId).OpenRead() : null;
        }
    }
}
