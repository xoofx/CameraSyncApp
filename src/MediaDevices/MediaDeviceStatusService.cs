...
namespace MediaDevices
{
    ...
    public class MediaDeviceStatusService : MediaDeviceService
    {
        ...
        protected override void Update()
        {
            ...
            keyCol.Add(WPD.SignalStrength);
            keyCol.Add(WPD.TextMessages);
            keyCol.Add(WPD.NewPictures);
            keyCol.Add(WPD.MissedCalls);
            keyCol.Add(WPD.VoiceMail);
            keyCol.Add(WPD.NetworkName);
            keyCol.Add(WPD.NetworkType);
            keyCol.Add(WPD.Roaming);
            keyCol.Add(WPD.BatteryLife);
            keyCol.Add(WPD.ChargingState);
            keyCol.Add(WPD.StorageCapacity);
            keyCol.Add(WPD.StorageFreeSpace);
            keyCol.Add(WPD.InternetConnected);
